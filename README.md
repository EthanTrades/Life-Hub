...
2. Click **+ → New repository**.
   - Name: `Life-Hub` (must match the URL in LifeHub.bat)
...
- The 7am / 9:35pm auto-syncs were scheduled on the laptop's Claude — they don't run on
  this PC. Ask Claude here to "sync my dashboard" manually, or to schedule it again.
